          ...
          <div className="w-full lg:flex">
            <div className="lg:w-1/2 lg:pl-44">
              ...
              <div className="mt-8 lg:mb-0 mb-8">
                ...
                >
                  Ecouter les dernières tendances du moment comme Oxalde: Ku Lo
                  sa , didi B X jr Low X Tamsir : en Haut ainsi que biens
                  d'autres son du moment sur Stream differently .
                </p>
                <div className="mt-6">
            ...
            <div className="lg:w-1/2 lg:ml-8">
              <div className="lg:flex items-start mb-8">
                ...
                <div className="lg:ml-6">
                  ...
                  >
                    Ne se limitant pas seulement à la musique "Stream
                    Differently" réinvente le streaming vous pouvez y retrouver
                    des séries à succès comme Elite , Euphoria , You et
                    plusieurs séries d'animations japonaises telles que One
                    piece , Naruto Shippuden ou Attack on Titan et d'autres
                    series populaires .
                  </p>
                  <div className="mt-4">
                    <a href="https://stream-differently.netlify.app/">
              ...
              <div className="lg:flex items-start mb-8">
                ...
                <div className="lg:ml-6">
                  ...
                  >
                    ...
                    baser à Abidjan Marcory plus précisement au boulevard
                    Amangou Victor vous pouvez prendre rendez-vous et contacter
                    l'entreprise grâce à un système de réservation de réunion
                    afin de permettre à l'entreprise de gérer au mieux ses
                    activités.
                  </p>
                  <div className="mt-4">
              ...
              <div className="lg:flex items-start mb-8">
                ...
                <div className="lg:ml-6">
                  ...
                  >
                    ...
                    général , la mise en relation d'affaires , Négoces de
                    Matières premières .
                  </p>
                  <div className="mt-4">
                    <a href="https://mounira-co.netlify.app/">

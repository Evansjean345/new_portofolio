...
export default function Contact() {
  ...
  return (
    <div className="container mx-auto pt-16 lg:px-12 rounded-lg">
      <div className="lg:flex">
        <div className="xl:w-2/5 lg:w-2/5 bg-indigo-800 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
          <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
            ...
            <div className="flex pb-4 items-center">
              ...
              <p className="pl-4 text-white text-base">+225 01 72 54 20 75</p>
            </div>
